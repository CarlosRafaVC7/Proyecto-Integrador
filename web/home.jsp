...
<div class="sidebar position-fixed top-0 bottom-0 bg-white border-end">
    <div class="d-flex align-items-center p-3">
        <a href="#" class="sidebar-logo text-uppercase fw-bold text-decoration-none text-indigo fs-4">ADMINISTRADOR</a>
    ...
    <ul class="sidebar-menu p-3 m-0 mb-0">
        ...
        <li class="sidebar-menu-divider mt-3 mb-1 text-uppercase">Admin Colegio</li>
        ...
        <li class="sidebar-menu-item has-dropdown">
            <a href="#">
                <i class="ri-calendar-check-line sidebar-menu-item-icon"></i>
                Gestión de Eventos
                <i class="ri-arrow-down-s-line sidebar-menu-item-accordion ms-auto"></i>
            </a>
            <ul class="sidebar-dropdown-menu">
...
<main class="bg-light">
    <div class="p-2">
        ...
        <nav class="px-3 py-2 bg-white rounded shadow-sm">
            ...
            <h5 class="fw-bold mb-0 me-auto">Lista de Alumnos</h5>
